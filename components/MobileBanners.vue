<template>
  <div class="relative text-base">
    ...
    <div class="mt-5 grid grid-cols-1 shadow-md p-5">
      ...
      <div>
        <label for="" class="text-gray-600 mb-2 block">Mobile Main Slider Images</label>
        <no-ssr>
        ...
        <div class="">
          ...
          <div>
            <div
              ...
              "
              class="m-5 h-64 bg-gray-300 rounded-sm cursor-pointer flex justify-center items-center"
            >
            ...
            <div class="relative m-5" v-else>
              ...
              <button
                ...
                type="button"
                class="absolute top-1/2 md:top-5 right-5 opacity-100 text-red-500 shadow bg-white rounded-full text-sm p-3 ml-auto inline-flex items-center"
...
export default {
  ...
  methods: {
    ...
    async loadAllMobileBanners() {
      const data = await this.$store.dispatch("home/loadAllMobileBanners");
    ...
    saveBaneners() {
      ...
      this.$store.dispatch("home/saveMainMobileSliderImages", formData).then((res) => {
    ...
    saveBannerImage(image_no) {
      ...
      switch (image_no) {
        case 1:
          ...
          endpoint = "saveMobileBannerImage1";
          break;
        case 2:
          image = this.banner_image_2;
          endpoint = "saveMobileBannerImage2";
          break;
    ...
    removeSliderImages(id) {
      ...
      this.$store
        .dispatch("home/removeMobileSliderImage", { slider_image_id: id })
        .then((res) => {
          this.main_slider_images_db = [];
          this.loadAllMobileBanners();
          swal("Success!", res.message, "success");
    ...
    removeSelectedBannerImage(no) {
      this.$store
        .dispatch("home/removeMobileBannerImage", { banner_no: no })
        .then((res) => {
          this.loadAllMobileBanners();
          swal("Success!", res.message, "success");
        });
